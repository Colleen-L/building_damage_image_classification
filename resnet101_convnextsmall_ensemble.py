...
# ConvNeXt-Small
conv_model = convnext_small(weights=ConvNeXt_Small_Weights.DEFAULT)
...
pd.DataFrame(rows, columns=["ID","Label"]).to_csv("resnet101_convnext_small_ensemble.csv", index=False)
print("Wrote resnet101_convnext_small_ensemble.csv")